...
makeTestUnit :: Ord a => AlgebraicGraph a -> (Set a, Set (a, a))
...
testSplitNode = tests 5 15
    [ 
        testVal "test splitNode 1" (makeTestUnit res1) (makeTestUnit (splitNode 1 (Set.fromList [5, 6, 7]) testGraph1)),
        testVal "test splitNode 2" (makeTestUnit res2) (makeTestUnit(splitNode 4 (Set.fromList [5, 6]) testGraph1)),
        testVal "test splitNode 3" (makeTestUnit res3) (makeTestUnit (splitNode 3 (Set.fromList [6, 7]) testGraph2)),
        testVal "test splitNode 4" (makeTestUnit res4) (makeTestUnit (splitNode 2 (Set.fromList []) testGraph3)),
        testVal "test splitNode 5" (makeTestUnit res5) (makeTestUnit (splitNode 3 (Set.fromList [5, 6]) testGraph3)),
        testVal "test splitNode 6" (makeTestUnit res6) (makeTestUnit (splitNode 5 (Set.fromList [7]) testGraph4))   
    ]
    where
...
testIsModule = tests 10 10
    [
        testVal "test isModule 1" True (isModule (Set.fromList [4]) testGraph1),
        testVal "test isModule 2" True (isModule (Set.fromList [1, 2, 3]) testGraph1),
        testVal "test isModule 3" False (isModule (Set.fromList [1, 2, 4]) testGraph1),
        testVal "test isModule 4" True (isModule (Set.fromList [1, 2]) testGraph2),
        testVal "test isModule 5" True (isModule (Set.fromList [2, 3]) testGraph3),
        testVal "test isModule 6" False (isModule (Set.fromList [1, 4]) testGraph3),
        testVal "test isModule 7" True (isModule (Set.fromList [7, 8]) testGraph9),
        testVal "test isModule 8" True (isModule (Set.fromList [1, 2, 3, 4, 5, 6, 7, 8]) testGraph9),
        testVal "test isModule 9" False (isModule (Set.fromList [1, 5]) testGraph9)
    ]
...
testIsModularPartition = tests 11 8
    ...
    where
        part1 = Set.fromList [Set.fromList [1], Set.fromList [2], Set.fromList [3], Set.fromList [4]]
        part2 = Set.fromList [Set.fromList [1, 2, 3, 4]]
        part3 = Set.fromList [Set.fromList [1, 2], Set.fromList [3, 4]]
        part4 = Set.fromList [Set.fromList [1, 2, 3], Set.fromList [4]]
        part5 = Set.fromList [Set.fromList [1, 2, 3]]
        part6 = Set.fromList [Set.fromList [1, 2, 3, 4], Set.fromList [5, 6, 7, 8], Set.fromList [9, 10, 11, 12]]
        part7 = Set.fromList [Set.fromList [1, 2, 3, 4], Set.fromList [5, 6], Set.fromList [7, 8], Set.fromList [9, 10, 11, 12]]
...
testMaximalModularPartition = tests 12 12
    ...
    where
        res1 = Set.fromList [Set.fromList [1,2,3], Set.fromList [4]]
        res2 = Set.fromList [Set.fromList [1,2], Set.fromList [3,4,5]]
        res3 = Set.fromList [Set.fromList [1], Set.fromList [2,3], Set.fromList [4]]
        res4 = Set.fromList [Set.fromList [1], Set.fromList [2], Set.fromList [3], Set.fromList [4], Set.fromList [5]]
        res5 = Set.fromList [Set.fromList [1,2,3,5,6,7], Set.fromList [4]]
        res61 = Set.fromList [Set.fromList ["apple","banana","pineapple"], Set.fromList ["orange","pear"]]
        res62 = Set.fromList [Set.fromList ["apple"], Set.fromList ["banana","orange","pear","pineapple"]]
...
checkAll = vmCheck $ algebraicGraph ++ modular
    where
        ...
        modular =
            [ testIsModule
            , testIsModularPartition
            , testMaximalModularPartition
            ]