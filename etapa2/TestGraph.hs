...
testNodes = tests 1 10
    [
        testVal "test nodes 1" (Set.fromList [1, 2, 3, 4]) (nodes testGraph1),
        testVal "test nodes 2" (Set.fromList [1, 2, 3, 4, 5]) (nodes testGraph2),
        testVal "test nodes 3" (Set.fromList [1, 2, 3, 4]) (nodes testGraph3),
        testVal "test nodes 4" (Set.fromList [1, 2, 3, 4,5 ]) (nodes testGraph4),
        testVal "test nodes 5" (Set.fromList [1, 2, 3, 4, 5, 6, 7]) (nodes testGraph5),
        testVal "test nodes 6" (Set.fromList [1, 2, 3, 4, 5, 6, 7, 8]) (nodes testGraph6),
        testVal "test nodes 7" (Set.fromList [1, 2, 3, 4]) (nodes testGraph7)
    ]
    
testEdges :: TestData
testEdges = tests 2 10
    [
        testVal "test edges 1" (Set.fromList [(1, 2),(1, 3)]) (edges testGraph1),
        testVal "test edges 2" (Set.fromList [(1,2),(3,4),(4,5),(5,3)]) (edges testGraph2),
        testVal "test edges 3" (Set.fromList [(1,2),(1,3),(1,4),(2,3),(4,1)]) (edges testGraph3),
        testVal "test edges 4" (Set.fromList [(1,2),(1,3),(2,3),(3,4),(3,5),(4,5),(5,1)]) (edges testGraph4),
        testVal "test edges 5" (Set.fromList [(1,2),(1,6),(2,3),(3,5),(6,3),(6,7),(7,5)]) (edges testGraph5),
        testVal "test edges 6" (Set.fromList [(1,2),(1,3),(1,4),(2,5),(3,6),(4,7),(6,8)]) (edges testGraph6),
        testVal "test edges 7" (Set.fromList [(1,2),(1,3),(1,4),(2,4),(4,1)]) (edges testGraph7)
    ]
...
testSplitNode = tests 6 20
    [ 
        ...
        testVal "test splitNode 4" (makeTestUnit res4) (makeTestUnit (splitNode 2 Set.empty testGraph3)),
...
toSets :: Ord a => [[[a]]] -> Set (Set (Set a))
toSets = Set.fromList . map (Set.fromList . map Set.fromList)
